...
def generate_script(subject,video_length,creativity, api_key):
    title_template = ChatPromptTemplate.from_messages(
        [
            ("human","请为'{subject}'这个主题的视频想一个吸引人的标题,开头请以【标题】隔开")])
    ...
    model = ChatOpenAI(model_name="7ba7726dad4c4ea4ab7f39c7741aea68",
                       api_key=api_key,
    ...
    return title,script
# print(generate_script("sora模型",1,0.7,"8c4d262358904b8eb230bd1b2fecb20b"))
